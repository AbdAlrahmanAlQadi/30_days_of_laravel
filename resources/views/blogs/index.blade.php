...
<x-layout>
    ...
    <div class="container mx-auto p-4">
            ...
            <div class="container">
                ...
                <a href="{{ route('blogs.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Add New
                    Blog</a>
                    ...
                    <div class="md:flex md:flex-col">
                        <a href="{{ route('blogs.show', $blog->id) }}"
                            ...
                            <div class="md:flex-shrink-0">
                                <img class="h-60 w-full object-cover" src="{{ asset('storage/images/' . $blog->image) }}"
                                    alt="{{ $blog->title }}">
                            </div>
                        </a>
                        <div class="p-6">
